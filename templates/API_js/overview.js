$(document).ready(function () {
    fetch('http://localhost/backend/userinfo.php', {
        ...
        document.getElementById("infobox").innerHTML +=
            ...
            `<div class="infocontent">${ar['username']}</div>` +
            `</div>` +
            `<div class="info">` +
            `<div class="infotitle">電話</div>` +
            `<div class="infocontent">${ar['phone']}</div>` +
            `</div>` +
            `<div class="info">` +
            `<div class="infotitle">信箱</div>` +
            `<div class="infocontent">${ar['mail']}</div>` +
            `</div>`
